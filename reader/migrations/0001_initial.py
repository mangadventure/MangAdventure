...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alias', models.CharField(blank=True, help_text='Another name for the artist.', max_length=100, unique=True)),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliases', to='reader.Artist')),
            ],
            options={
                'verbose_name': 'alias',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alias', models.CharField(blank=True, help_text='Another name for the author.', max_length=100, unique=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliases', to='reader.Author')),
            ],
            options={
                'verbose_name': 'alias',
                'verbose_name_plural': 'aliases',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date.today, help_text='The date the chapter was uploaded. You may choose a past date.', validators=[reader.modules.validators.no_future_date])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='The description of the series. HTML allowed.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alias', models.CharField(blank=True, help_text='Another title for the series.', max_length=250, unique=True)),
                ('series', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliases', to='reader.Series')),
            ],
            options={
                'verbose_name': 'alias',
                'verbose_name_plural': 'aliases',
