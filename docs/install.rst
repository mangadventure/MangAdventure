...
.. code-block:: bash
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.9.5#egg=mangadventure"
...
.. code-block:: bash
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.9.5#egg=mangadventure[csp,uwsgi]"
