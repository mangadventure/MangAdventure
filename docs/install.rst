...
Then, download and unzip the `latest release <https://github.com/evangelos-ch/MangAdventure/releases/latest>`_ and follow these steps to initialize the site:
