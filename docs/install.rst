...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.6.5#egg=mangadventure"
...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.6.5#egg=mangadventure[csp,uwsgi]"
