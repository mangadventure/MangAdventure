...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.6.2#egg=mangadventure"
...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.6.2#egg=mangadventure[csp,uwsgi]"
