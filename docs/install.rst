...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.8.3#egg=mangadventure"
...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.8.3#egg=mangadventure[csp,uwsgi]"
