...
.. code-block:: bash
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v1.0.0#egg=mangadventure"
...
.. code-block:: bash
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v1.0.0#egg=mangadventure[csp,uwsgi]"
...
(or regular CSS) in the ``static/styles/extra.scss`` file.
