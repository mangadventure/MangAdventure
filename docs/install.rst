...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.7.0#egg=mangadventure"
...
.. code-block:: shell
   ...
   pip install -e "git+https://github.com/mangadventure/MangAdventure@v0.7.0#egg=mangadventure[csp,uwsgi]"
